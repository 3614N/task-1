...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        img_1->setPixmap(QPixmap(QString::fromUtf8("../photo_2023-06-30_21-52-27.jpg")));

        gridLayout->addWidget(img_1, 1, 0, 1, 2);

        img_2 = new QLabel(centralwidget);
        img_2->setObjectName(QString::fromUtf8("img_2"));
        img_2->setPixmap(QPixmap(QString::fromUtf8("../photo_2023-06-30_21-52-27 (2).jpg")));
        ...
        img_3->setFont(font1);
        img_3->setPixmap(QPixmap(QString::fromUtf8("../photo_2023-06-30_21-52-28.jpg")));
